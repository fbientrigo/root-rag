...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate qrel review candidates from evidence artifacts."
    )
    parser.add_argument(
        "--evidence-dir", required=True, type=Path, help="Evidence directory with manifest.json."
    )
    ...
    parser.add_argument(
        "--overwrite", action="store_true", help="Allow overwriting candidates-path."
    )
