...
- **Rationale**: 45 MeV corresponds to the characteristic energy loss of a Minimum Ionizing Particle (MIP) in 30 cm of liquid scintillator (approx 1.5 MeV/cm).
<!-- CLAIM: PROVISIONAL -->
<!-- SOURCE: [[EXTERNAL_EVIDENCE_REGISTRY#EXT-002]] -->
...
- **Rationale**: 0.1 GeV/c is the standard simulation tracking cut-off used in SHiP background studies to ensure tracking stability.
<!-- CLAIM: PROVISIONAL -->
<!-- SOURCE: [[EXTERNAL_EVIDENCE_REGISTRY#EXT-001]] -->
